...
public class GetObuHistoryRawDataServlet extends InitServlet {

	Locale locale = Locale.getDefault();
	
	//static Logger log = Logger.getLogger(ObuSettingsServlet.class.getName());
	private static Log log = LogFactory.getLog(GetObuHistoryRawDataServlet.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<StateData> obuHistoryData = obuData.getObuHistoryRawData(Integer.parseInt(obuid));
		Gson gson = new Gson();
