...
public class SetRefreshTimeServlet extends HttpServlet {

	Locale locale = Locale.getDefault();
	
	private static Log log = LogFactory.getLog(SetRefreshTimeServlet.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String result = egData.setRefreshTime(egId, refreshTime);
